    ...
    <div class="row">
            ...
            <?php if(!isset($_SESSION['user_logged_in'])): ?> 
                ...
                <?php
                    ...
                    <p><?php echo isset($translations['logged_in_as']) ? htmlspecialchars( $translations['logged_in_as'], ENT_QUOTES, 'UTF-8') : 'Logged in as'; ?>&nbsp;<b><?php echo $_SESSION['member_user_name'];?></b> &nbsp;<a style="text-transform: lowercase;" id="logoutBtn" class="mb-5" style="cursor: pointer;"><?php echo isset($translations['logout']) ? htmlspecialchars($translations['logout'], ENT_QUOTES, 'UTF-8') : 'Log out'; ?></a></p>
